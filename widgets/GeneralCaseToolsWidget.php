...
class GeneralCaseToolsWidget extends Widget
{
    ...
    public function run()
    {
        ...
        //     return  $activeIntake;
        // }
        $toolsData = WorkflowTools::find()->where(['wid' => $this->wid, 'status' => 1, 'mandatory' => 0])->all();
        echo '<div class="card">
        <div class="body">
            <div id="mail-nav">
                <h5 class="b-b p-10 text-strong">General Case Tools</h5>
