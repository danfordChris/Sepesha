...
class m240914_170838_workflows_data extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert(
            ...
            [
                [1, 1, 1, 'Request Verification', 'Ok,Submit', 'Y', 'No, Rectify', 'N', NULL, 'active', 1, '2024-09-07 19:47:25', NULL, NULL, 2, 1, 'Verified', 'Not Verified'],
                [2, 1, 2, 'Review & Approval', 'Approve', 'Y', 'No, Rectify', 'N', NULL, 'active', 1, '2024-09-07 19:55:50', NULL, NULL, 3, 1, 'Approved', 'Not Approved'],
                [3, 2, 1, 'Request Verification', 'Ok,Submit', 'Y', 'No, Rectify', 'N', NULL, 'active', 1, '2024-09-14 19:44:00', NULL, NULL, 2, 1, 'Verified', 'Not Verified'],
