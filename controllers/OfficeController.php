...
class OfficeController extends Controller
{
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        ...
                        'roles' => ['@'],
                        'matchCallback' => function ($rule, $action) {
                            return  User::auth('create_offices');
                        }
                    ],
                    [
                        'allow' => true,
    ...
    public function actionIndex()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                if ($model->save()) {
                    Yii::$app->session->setFlash('success', "Office Added Successfully");
                    return $this->redirect(['index']);
                } else
                    Yii::$app->session->setFlash('danger', 'Failed to Add Office!.');
            } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($this->request->isPost && $model->load($this->request->post())) {
            ...
            if ($model->save()) {
                Yii::$app->session->setFlash('success', "Office: " . $model->name . "  Updated successfully");
                return $this->redirect(['index']);
            } else
