        ...
        <?= DataTables::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format' => 'html',
                    'value' => function ($model) {
                        $options = CustomHelper::getStatusOptions(); // Use CustomHelper to get status options
                    ...
                    'buttons' => [
                        'update' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['services/update', 'rca' => Yii::$app->getSecurity()->hashData($model->id, 'gmtdev'), 'edit' => 't']),
                        ...
                        'view' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['services/view', 'rca' => Yii::$app->getSecurity()->hashData($model->id, 'gmtdev'), 'view' => 't']),
    ...
    <div class="modal-dialog modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title mb-2 font-weight-bold text-white" id="formModal"><strong>Services
                        Details</strong></h4>
            </div>
