    ...
    <div class="row">
        ...
        <div class="col-4">
            <?= $form->field($model, 'stid')->widget(DepDrop::class, [
                ...
                'data' => $model->isNewRecord ? '' : WfStages::getStages(),
        ...
        <div class="col-4">
            <?= $form->field($model, 'toolid')->widget(Select2::class, [
                'options' => ['placeholder' => 'Select Tool', 'required' => true],
                'data' => WorkflowDocuments::getTools(),
                'pluginOptions' => [
                    'allowClear' => true,
                    'dropdownParent' => $parent
                ],
