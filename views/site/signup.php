...
?>
 <div class="card mg-b-20" id="tabs-style3">
							<div class="card-body">
								...
								<p class="mg-b-20">User  management and authentication module , here you can ,edit ,active,disable and change password of users.
								</p>
								<div class="text-wrap">
									<div class="example">
											...
											<div class="tab-menu-heading">
												<div class="tabs-menu ">
													...
													<ul class="nav panel-tabs">
														<li class=""><a href="#tab11" class="btn btn-outline-info" data-bs-toggle="tab"><i class="fa fa-user me-1"></i> Manage Users</a></li>
														&nbsp;
