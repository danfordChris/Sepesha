...
?>
<div class="bank-accounts-index card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <button type="button" class="btn mb-2 float-end  btn-outline-info" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                    <i class="fas fa-money-check-alt"></i> Add Bank Account</button>
            </div>
        </div>
        ...
        <?= DataTables::widget([
            ...
            'tableOptions' => ['class' => ' table table-responsive bordered text-nowrap table-sm'],
                    ...
                    'buttons' => [
                        'update' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['bank-accounts/update', 'id' => $model->id, 'edit' => 't']),
                        ...
                        'view' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['bank-accounts/view', 'id' => $model->id, 'view' => 't']),
    ...
    <div class="modal-dialog modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title mb-2 font-weight-bold text-white" id="formModal"><strong>Enter Bank Account Details</strong></h4>
            </div>
