...
/** @var app\models\ProgramsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('app', 'Intervention Programs');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="programs-index card">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <button type="button" class="btn mb-2 float-end  btn-outline-info" data-bs-toggle="modal" data-bs-target="#rcamodal">
                    <i class="fa fa-plus"></i> Add Programs</button>
            </div>
        </div>
                    ...
                    'buttons' => [
                        'update' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['programs/update', 'rca' => Yii::$app->getSecurity()->hashData($model->id, 'gmtdev'), 'edit' => 't']),
                        ...
                        'view' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['programs/view', 'rca' => Yii::$app->getSecurity()->hashData($model->id, 'gmtdev'), 'view' => 't']),
    ...
    <div class="modal-dialog modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title mb-2 font-weight-bold text-white" id="formModal"><strong>Program Details</strong></h4>
            </div>
