        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <button type="button" class="btn mb-2 float-end  btn-outline-info" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                    <i class="fa fa-home"></i> Add Office</button>
            </div>
        </div>
                    ...
                    'buttons' => [
                        'update' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['office/update', 'id' => $model->id, 'edit' => 't']),
                        ...
                        'view' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['office/view', 'id' => $model->id, 'view' => 't']),
    ...
    <div class="modal-dialog modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title mb-2 font-weight-bold text-white" id="formModal"><strong>Enter Office Details</strong></h4>
            </div>
