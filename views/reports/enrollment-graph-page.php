...
<?php $script = <<< JS
        ...
        $.get("enrollment-chart", function(data) {
        var total=0;
        ...
        return e.dataPoint.label; // Show only the label in the legend
        }
        },
        data: [{
        type: "pie" ,
        ...
        indexLabel: "{label} - {y}%" ,
        dataPoints: dataWithPercentages // Use the transformed data
        }]
        });
        ...
        $(window).resize(function(){
                var containerWidth = $("chartContainer").width();
                console.log('jdakdamda',containerWidth);
                var containerHeight = $("chartContainer").height();
