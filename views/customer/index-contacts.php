...
$this->title = 'Beneficiary Contacts ';
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <button type="button" class="btn mb-2 float-end  btn-outline-info" data-bs-toggle="modal"
                    ...
                    <i class="fa fa-user"></i> Add Contacts</button>
            </div>
        </div>
                    ...
                    'buttons' => [
                        ...
                        'view' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['customer/view', 'id' => $model->id, 'view' => 't']),
        ...
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title mb-2 font-weight-bold text-white" id="formModal"><strong>Enter
                        <?= $this->title ?> details </strong></h5>
            </div>
            <div class="modal-body">
                <?= $this->render('create-contacts', ['model' => $model]); ?>
            </div>
        </div>
    </div>
</div>