                    ...
                    'buttons' => [
                        'update' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['country/update', 'rca' => Yii::$app->getSecurity()->hashData($model->country_id, 'gmtdev'), 'edit' => 't']),
                        ...
                        'view' => function ($url, $model) {
                            return Html::a(
                                ...
                                Yii::$app->urlManager->createUrl(['country/view', 'rca' => Yii::$app->getSecurity()->hashData($model->country_id, 'gmtdev'), 'view' => 't']),
    ...
    <div class="modal-dialog modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title mb-2 font-weight-bold text-white" id="formModal"><strong>Enter Country Details</strong></h4>
            </div>
