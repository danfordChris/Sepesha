...
<?php
    ...
    <div class="row">
        ...
        <?= $form->field($model, 'type')->widget(Select2::class, [
                    'data' => CaseReasons:: getCasereasonsOptions(),
                    'options' => ['placeholder' => 'Select type', 'required' => true],
                    'pluginOptions' => [
                        'allowClear' => true,
 ...
 <div class="row">
    ...
    <?php if (!$model->isNewRecord) : ?>
                <?= $form->field($model, 'status')->dropDownList(CaseReasons::getStatusOptions()) ?>
        <?php endif; ?>
    </div>
 </div>
